...
public class OnyxAttachmentUriProvider implements AttachmentUriProvider {
    ...
    private List<String> initFile() {
        ...
        result.add(getUriStr(Directory.EXTERNAL_CACHE, "log/util-01-06.txt"));
        return result;
    }
     ...
     *
     * @param directory
     *         refer to {@link Directory}
     * @param filePath
     *         relative path. eg: log/util-01-06.txt
     *
